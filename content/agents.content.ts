...
export interface AgentsContent {
  ...
  workflowBand: { title: string; body: string };
  agents: AgentProfile[];
  cta: { title: string; primary: string; secondary: string };
}

// Verbatim from /source-content/Agents.md — do not paraphrase.
export const agentsContent: AgentsContent = {
  hero: {
    eyebrow: "Agent Workforce",
    title: "A workforce built for enterprise scale.",
  ...
  agents: [
    ...
    },
    {
      ...
      role: "Orchestration",
      headline:
        "Delivery cadence, dependency management, and stakeholder narrative across every run.",
  ...
  cta: {
    title: "See the workforce in a live program.",
    primary: "Request a Live Demo",
    secondary: "Explore Governance",
  },
};
